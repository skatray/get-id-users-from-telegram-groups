...
*
* @name       get id users from telegram groups
...
* @copyright  (c) 2021.02, Skatray, Inc
* @link       
*
**/
...
lang_f();
let html="";
document.querySelectorAll("a.composer_mention_option").forEach(e=>{ 
  let id=e.attributes[1].value.substr(1)
  let name=e.attributes[3].value
  data+="@"+id+" ("+name +")\n" //type for print
  html+="@"+id+" ("+ name+")<br>" 
})
  ...
  if(e=="ru") {
    return  lang={
      ...
      return  lang={
        ...
        window.LiqPayCheckoutCallback = function() {
          LiqPayCheckout.init({
            data: "eyJ2ZXJzaW9uIjozLCJhY3Rpb24iOiJwYXlkb25hdGUiLCJhbW91bnQiOiIxIiwiY3VycmVuY3kiOiJVU0QiLCJkZXNjcmlwdGlvbiI6ItCc0ZbQuSDRgtC+0LLQsNGAIiwicHVibGljX2tleSI6Imk1MDA5MDQwNTQxOSIsImxhbmd1YWdlIjoiZW4ifQ==",
            signature: "7xzlnlVYB0xLOu72IBbiMoZ7UbA=",
            embedTo: "#liqpay_checkout",
            mode: "embed" // embed || popup,
          }).on("liqpay.callback", function(data){
            console.log(data.status);
